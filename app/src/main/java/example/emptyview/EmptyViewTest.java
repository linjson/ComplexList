...
public class EmptyViewTest extends Activity implements RefreshPullView.OnLoadingMoreListener, RefreshPullView.OnRefreshingListener {
    ...
    private void initView() {
        ...
        findViewById(R.id.empty).setOnClickListener(v -> {
            adapter.setData(null);
        });

        findViewById(R.id.data).setOnClickListener(v -> {
            data = createStudents();
    ...
    public void doLoadingMoreData(final RefreshPullView view) {
        ...
        sHandler.postDelayed(() -> {
            ...
            Toast.makeText(EmptyViewTest.this, "loading结束", Toast.LENGTH_SHORT).show();
        }, 1000);
    }
    ...
    public void doRefreshingData(final RefreshPullView view) {
        ...
        sHandler.postDelayed(() -> {
            ...
            Toast.makeText(EmptyViewTest.this, "refreshing结束", Toast.LENGTH_SHORT).show();
